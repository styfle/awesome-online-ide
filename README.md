...
- [Refinery Labs](https://refinery.io/) <img title="Sign Up Required" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/shopify.svg" /> - Simply write, chain, and deploy AWS Lambda functions without ever having to look under the hood. Build HTTP APIs, massive map-reduce jobs, or drop into your existing AWS setup with an editor built on [Monaco Editor](https://microsoft.github.io/monaco-editor/) [<img title="Open Source" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/github.svg" />](https://github.com/Microsoft/monaco-editor).
