...
* [Eclipse Che](https://www.eclipse.org/che) [<img title="Open Source" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/github.svg" />](https://www.eclipse.org/che) [<img title="Self Hosted" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/docker.svg" />](https://hub.docker.com/r/eclipse/che) - Developer workspace server and cloud IDE built for teams and organizations. Running on Kubernetes, Openshift and Docker.
