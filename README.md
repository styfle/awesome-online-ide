...
* [Wide](https://github.com/b3log/wide) - Run Go in the browser (including mobile) with expression-info, autocomplete and jump to declaration - self hosted or use cloud (requires registration)
